...
router.get('/jwt/refresh', middleware_1.isAuthenticated, controller_1.refresh);
// Verify user account via email
router.get('/verify', rateLimiterMemory_1.default, controller_1.verify);
router.get('/resetpassword', rateLimiterMemory_1.default, controller_1.resetPassword);
/**
 * @swagger
 *
 * /account/login:
 ...
 */
router.post('/login', rateLimiterMemory_1.default, controller_1.login);
/**
 * @swagger
 *
 * /account/register:
 ...
 */
router.post('/register', rateLimiterMemory_1.default, controller_1.register);
/**
 * @swagger
 *
 * /account/forgot:
 ...
 */
router.post('/forgot', rateLimiterMemory_1.default, controller_1.forgot);
/**
 * @swagger
 *
 * /account/reset:
 ...
 *                      example: Something went wrong. Please try again later.
 */
router.post('/reset/:token', rateLimiterMemory_1.default, controller_1.reset);
/**
 * @swagger
 *
 * /account/profile:
 ...
 *                      example: Something went wrong. Please try again later.
 */
router.get('/profile', middleware_1.isAuthenticated, controller_1.getProfile);
router.post('/profile', middleware_1.isAuthenticated, controller_1.postProfile);
router.post('/password', middleware_1.isAuthenticated, controller_1.password);
router.post('/delete', middleware_1.isAuthenticated, controller_1.deleteAccount);
router.post('/first-time', middleware_1.isAuthenticated, controller_1.clearFirstTimeUserFlag);
